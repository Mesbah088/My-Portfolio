        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              ...
              to be part of your vision. Feel free to get in touch through any of the
              following channels.
            </p>
          ...
          <div>
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg border border-gray-200">
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 bg-primary text-white rounded-lg hover:bg-green-600 transition-colors font-medium"
              >
                Send Message
              </button>
            </form>
